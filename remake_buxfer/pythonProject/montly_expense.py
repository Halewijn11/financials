...
class Monthly_Expense:
    def __init__(self, month, year):
        ...
        self.month = month
        self.year = year
        self.download_folder = variables.download_folder
        ...
        self.food_categories = variables.food_categories
...
if __name__ == "__main__":
    ...
    expense_1_2024 = Monthly_Expense(1, 2024)
    print(expense_1_2024.sorted_download_file_df)
